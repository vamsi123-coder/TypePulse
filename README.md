...
### ✨ Features
*   **Dual Themes**: Sleek Dark Mode (default) and Light Mode toggled via the top-right sun/moon icon. Your preference is persisted automatically using `localStorage`.
...
| :--- | :--- | :--- | :--- |
| **Row 1: WPM & Time** | **Gross WPM** (Raw speed based on total keys hit, to 1 decimal place) | **Net WPM** (Adjusted speed penalized for mistakes, to 1 decimal place) | **Total Time** (Total duration of test in seconds) |
...
| **Row 3: Word Stats** | **Total Words** (Total words in the text) | **Correct Words** (Perfect matching words) | **Accuracy (Word)** (Percentage of correct words) |
...
*   **Net WPM** = `Gross WPM - (Incorrect Words / (Time in Seconds / 60))`
*   **Character Accuracy** = `(Correct Characters / Total Typed Characters) * 100`
*   **Word Accuracy** = `(Correct Words / Total Paragraph Words) * 100`
